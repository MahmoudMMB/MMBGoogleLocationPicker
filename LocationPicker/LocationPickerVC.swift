...
//  Plover
//
//  Created by Mahmoud Al-Belbeisi on 6/18/20.
...
open class LocationPickerVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    /**
     ...
     - important:
     If you override `func locationDidDeny(LocationPickerVC: LocationPicker)` without calling `super`, this closure would not be called.
     ...
     * Delegate
     1. conform to `protocol LocationPickerDelegate`
     2. set the `var delegate`
     3. implement `func locationDidDeny(LocationPickerVC: LocationPicker)`
     * Override
     1. create a subclass of `class LocationPicker`
     2. override `func locationDidDeny(LocationPickerVC: LocationPicker)`
     
     - SeeAlso:
     `func locationDidDeny(LocationPickerVC: LocationPicker)`
     ...
     */
    open var locationDeniedHandler: ((LocationPickerVC) -> Void)?
...
//    public var contentView = UIView()
    ...
    open var longitudinalDistance: Float!
    ...
    private func setupViews() {
        ...
        self.resultView?.placeholder = searchBarPlaceholder
        self.resultView?.textColor = primaryTextColor
...
extension LocationPickerVC {
     ...
     */
    public func locationDidDeny(locationPicker: LocationPickerVC) {
        locationDeniedHandler?(self)
